...
function Header({ email, loggedIn }) {
  ...
  function toggleMenu() {
    // добавить setMenuOpen(false) при увеличении размера экрана
          ...
          <Switch>
            <Route exact path="/">
              {loggedIn && (
                ...
                >
                  <Link className="link link__movies" to="movies">
                    Фильмы
                  </Link>
                  <Link className="link link__movies" to="saved-movies">
                    Сохраненные фильмы
                  </Link>
                </div>
              )}
              ...
              {loggedIn && (
                <button
                  className={`${
                    isMenuOpen
                      ? "header__menu header__menu_close"
                      : "header__menu"
                  }`}
                  type="button"
                  aria-label="меню"
            ...
            <Route path="/movies">
              ...
              >
                <Link
                  className={`${isMenuOpen ? "link link__movies" : "link_off"}`}
                  to=""
                >
                  Главная
                </Link>
            ...
            <Route path="/saved-movies">
              ...
              >
                ...
                <p className="link link__movies link__movies_active">
                  Сохраненные фильмы
                </p>
              </div>
              <div className={`account ${isMenuOpen ? "account_on" : ""}`}>
